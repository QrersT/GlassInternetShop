...
function headerSearch(getLink) {
  fetch(getLink)
    .then((res) => res.json())
    .then((data) => console.log(data));
}
headerSearch("https://jsonplaceholder.typicode.com/users");

//-----------------------------------------------------------------
//add class on scroll
function hederAddFixedAnimationClass() {
  const header = document.querySelector(".header");
  const toggleClass = "_header-sticky";
